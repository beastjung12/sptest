...
<body>	
	...
	<div id="wrap">
		<!-- header -->				
		<header id="header">
			<h1><a href="${pageContext.request.contextPath}/index.jsp"><img alt="로고 이미지" src="${pageContext.request.contextPath}/images/herbLogo7.jpg" height="95px" /></a></h1>
			<nav id="headerRight">
				<ul class="views">		
					<!-- 로그인된 경우 -->			
					<c:if test="${!empty sessionScope.userid }">
						<li><a href="${pageContext.request.contextPath}/login/logout.jsp">로그아웃</a></li>
						<li><a href="${pageContext.request.contextPath}/member/memberEdit.jsp">회원정보수정</a></li>	            
						<li><a href="${pageContext.request.contextPath}/member/memberOut.jsp">회원탈퇴</a></li>
					</c:if>		            
					<!-- 로그인 안된 경우 -->
					<c:if test="${empty sessionScope.userid }">
						<li><a href="${pageContext.request.contextPath}/login/login.do">로그인</a></li>
						<li><a href="${pageContext.request.contextPath}/member/agreement.do">회원가입</a></li>	            
					</c:if>
					
					<li><a href="${pageContext.request.contextPath}/shop/cart/cartList.do">장바구니</a></li>
					<li><a href="${pageContext.request.contextPath}/shop/order/orderList.do">주문내역</a></li>
					<li><a href="${pageContext.request.contextPath}/shop/mypage.do">마이페이지</a></li>
					<li><a href="${pageContext.request.contextPath}/board/list.do">고객센터</a></li>					
				</ul>				
			</nav>
		</header>
