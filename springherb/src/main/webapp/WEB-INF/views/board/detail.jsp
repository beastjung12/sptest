...
<body>
	...
	<div class="divForm">
		...
		<div class="lastDiv">			
			<p class="content">${fn:replace(boardVo.content, newLine, "<br>")}</p>
		</div>
		<div class="center">
			<a href="<c:url value='/board/edit.do?no=${boardVo.no}'/>">수정</a> |
        	<a href="<c:url value='/board/delete.do?no=${boardVo.no}'/>">삭제</a> |
