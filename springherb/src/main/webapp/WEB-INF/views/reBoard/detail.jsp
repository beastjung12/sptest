...
="<c:url value='/reBoard/download.do?no=${reBoardVo.no}&fileName=${reBoardVo.fileName}'/>">
		...
		<div class="center">
			<a href="<c:url value='/reBoard/edit.do?no=${reBoardVo.no}'/>">수정</a> |
        	<a href="<c:url value='/reBoard/delete.do?no=${reBoardVo.no}'/>">삭제</a> |
        	<a href="<c:url value='/reBoard/reply.do?no=${reBoardVo.no}'/>">답변</a> |
